...
DEFAULT_BATCH_SIZE = 1  # could be causing noisy gradients?
...
DEFAULT_OPTIMIZER = OptimizerFactory(name="sgd", lr=DEFAULT_LR, momentum=0.9, bcosify=True, b_opt=False, weight_decay=1e-4)
